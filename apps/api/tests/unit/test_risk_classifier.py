...
def test_risk_classifier_high_risk():
    ...
    req2 = ActionRequest(tool_name="execute_sql_query", arguments={}, requires_approval=True)
...
def test_risk_classifier_low_risk():
    ...
    req2 = ActionRequest(tool_name="some_random_tool", arguments={}, requires_approval=False)
