...
class DocumentChunk(BaseModel):
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Source, page number, author, etc.")
...
class RetrievedContext(BaseModel):
    ...
    document_id: str
    text: str
    score: float = Field(..., description="The combined RRF score or raw similarity score.")
