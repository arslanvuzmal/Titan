...
class SalesAgent:
    ...
    async def invoke(state: TitanAgentState) -> TitanAgentState:
            ...
            "action_requests": [
                {
                    ...
                    "arguments": {"lead_id": event_payload.get("lead_id", "unknown"), "score": 85},
                    "requires_approval": False
                },
                {
                    "tool_name": "send_email",
                    "arguments": {"to": event_payload.get("email", "unknown@example.com"), "body": "Hi there..."},
        ...
        try:
            ...
            state["pending_actions"].extend([req.model_dump() for req in validated_output.action_requests])
