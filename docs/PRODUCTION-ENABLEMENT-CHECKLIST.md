...
- [ ] **Primary Domain Configuration:**
  - Verify ownership of domain `arslanvuzmallone.com`.
  - Dedicate a sending subdomain for outreach (e.g. `mail.arslanvuzmallone.com` or `send.arslanvuzmallone.com`).
- [ ] **DNS Authentication Records:**
  ...
  - **DMARC Record:** Add TXT record to `_dmarc.arslanvuzmallone.com`: `v=DMARC1; p=reject; rua=mailto:dmarc@arslanvuzmallone.com; pct=100;`.
